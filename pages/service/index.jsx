                    ...
                    <div className="flex flex-wrap w-full justify-evenly">
                        {
                            ...
                            services.map(service => {
                                return <div key={service._id} className="flex-col-3 justify-between lg:flex lg:justify-between">
                                    <div className="topfirst bg-white md:w-96 sm:w-64 w-72 rounded-md px-2 py-6 flex flex-col justify-center hover:shadow-xl card-hover m-auto gap-5 mb-10 lg:m-10" data-aos="zoom-in" data-aos-duration="1000">
