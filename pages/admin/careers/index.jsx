              ...
              careers.map(career => {
                return <div key={career?._id} className='p-5 border-2 bg-white rounded-md shadow-lg  my-3'>
                  ...
                  <Link href={`/admin/careers/update/${career?._id}`}>
                    <button className='border-2 border-none bg-yellow-500 hover:text-white w-20 h-8 rounded-md mx-1 mb-1 sm:mb-0'>Update</button>
                  </Link>
                  ...
                  <Link href={`/admin/careers/appliedCareer/${career?._id}`}>
                    <button className='border-2 border-none bg-blue-600  hover:text-white sm:w-44 w-40 h-8  rounded-md  mx-1 '>Applied Applicants</button>
                  </Link>
                  </div>
