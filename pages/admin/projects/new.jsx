...
const AddProject = () => {
    ...
    return (
        <div className='bg-blue-200' style={{ minHeight: "82.3vh" }}>
            ...
            <form className='border-2 shadow-lg bg-white rounded-md mb-10 md:ms-7 md:me-0 ms-auto me-auto lg:w-3/5 md:w-5/6 w-11/12 xl:p-10 md:p-5 p-2'>
                <h1 className='font-bold lg:text-3xl lg:text-left text-center md:text-2xl pb-4'>Add Projects</h1>
                {showError()}
                {showSuccess()}
                ...
                <input type="file" id='image' name="project_image" className='border border-black p-1 md:text-lg rounded-md md:h-11 md:h-10' onChange={handleChange} ref={file_ref} />
                <button onClick={handleSubmit} className="border border-none bg-blue-600 rounded-md md:w-20 md:h-10 w-14 h-7 lg:mt-5 mt-3 md:text-lg text-sm"><a href="#" className=' hover:text-white'>Add</a></button>
            </form>
        </div>
    )
}
