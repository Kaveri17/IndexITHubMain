            ...
            sectionContent = (
                <>
                    <div className='mt-6 ' >
                        ...
                        <div className='mt-5 font-light mx-1 lg:mx-16 flex justify-between flex-wrap'>
                            <div className=''>
                                <div className='mb-2'>
                                    <h1>Full Name:</h1>
                            ...
                            <div className='md:flex mt-5'>
                                ...
                                <div className='bg-white ms-0 lg:ms-8 p-5 rounded-xl lg:w-9/12 text-xs md:text-md lg:text-lg'>
                                    <div className='columns-1 lg:columns-2 border-b border-dashed border-b-gray-700 pb-2'>
                                        <h1 className='hover:text-blue-600 hover:underline hover:underline-offset-2 cursor-pointer' onClick={() => handleSectionChange('overview')}>Overview</h1>
                                        <h1 className='hover:text-blue-600 hover:underline hover:underline-offset-2 cursor-pointer' onClick={() => handleSectionChange('editprofile')}>Edit Profile</h1>
                                    </div>
                                    {sectionContent}
                                </div>
                            </div>
