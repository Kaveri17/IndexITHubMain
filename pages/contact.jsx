    ...
    <div className='text-[#13294b] lfooter'>
      ...
      <div className=" px-5 md:px-32 py-24 mx-auto flex sm:flex-nowrap flex-wrap" >
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative" >
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113032.56092275828!2d85.1702340971312!3d27.709025043879382!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xa35177c4a04efdc7%3A0x718992725c580f68!2sIndex%20I.T.%20Hub!5e0!3m2!1sen!2snp!4v1717568791166!5m2!1sen!2snp" width="100%" height="100%" className="absolute inset-0" title="map" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md invisible md:visible " data-aos="fade-up" data-aos-duration="2000">
            <div className="lg:w-1/2 px-6" >
              ...
              <p className="mt-1 text-left">Jyatha, Talachhi Marga, Kathmandu</p>
            </div>
